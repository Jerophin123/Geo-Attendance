...
# Database connection function for MariaDB
def get_db_connection():
    conn = mariadb.connect(
        user="jero",          # Replace with your MariaDB username
        password="1168",  # Replace with your MariaDB password
        host="192.168.0.189",                  # Replace with your MariaDB host (e.g., "127.0.0.1" or actual IP)
...
# Initialize the database with MariaDB
def init_db():
    ...
    # Create the OffsiteAttendance table
    cursor.execute('''
